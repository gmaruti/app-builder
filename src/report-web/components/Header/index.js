  ...
  render() {
    ...
    return (
      <div style={{background:'white', height:`${height}`, paddingLeft:'0px'}}>
        ...
        <span style={{margin:'2%'}}><a style={{textDecaration: 'none'}} href="http://localhost:3000/report/station"> Station</a></span>
        <span style={{margin:'2%'}}><a style={{textDecaration: 'none'}} href="http://localhost:3000/report/program">Program</a></span>
